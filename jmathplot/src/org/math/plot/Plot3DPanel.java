...
public class Plot3DPanel extends PlotPanel {
    ...
    public int addSomasScatterPlot(String name, Color color, double[] X, double[] Y, double[] Z, BitSet[] chromosomes, int numBits, String scenarioName) {
        return ((Plot3DCanvas) plotCanvas).addSomasScatterPlot(name, color, X,Y,Z, chromosomes, numBits, scenarioName);
    }
