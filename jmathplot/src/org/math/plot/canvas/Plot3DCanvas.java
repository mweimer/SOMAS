...
public class Plot3DCanvas extends PlotCanvas {
	...
	public int addSomasScatterPlot(String name, Color c, double[] X, double[] Y, double[] Z, BitSet[] chromosomes, int numBits, String scenarioName) {
		return addPlot(new SomasScatterPlot(name, c, convertXYZ(X,Y,Z), chromosomes, numBits, scenarioName));
	}
