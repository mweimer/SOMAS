 ...
 */
public class BitFlipMutation_SOMAS extends Mutation {
	/**
	 ...
	 * Creates a new instance of the Bit Flip mutation operator
	 */
	public BitFlipMutation_SOMAS(Properties properties) {
		this();
	} // BitFlipMutation
	 ...
	 * @throws JMException
	 */
	public void doMutation(double probability, double bitFlipProbability, Solution solution) throws JMException {
		try {
				...
				if (PseudoRandom.randDouble() < probability) {
					for (int i = 0; i < solution.getDecisionVariables().length; i++) {
						for (int j = 0; j < ((Binary) solution.getDecisionVariables()[i]).getNumberOfBits(); j++) {
							if (PseudoRandom.randDouble() < bitFlipProbability) {
	...
	public Object execute(Object object) throws JMException {
		...
		Double bitFlipProbability = (Double) getParameter("bitFlipProbability");
		if (probability == null) {
		...
		doMutation(probability.doubleValue(), bitFlipProbability.doubleValue(), solution);
		return solution;
	} // execute
} // BitFlipMutation
