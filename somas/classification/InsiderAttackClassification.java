...
public class InsiderAttackClassification extends Scenario {
	...
	public InsiderAttackClassification() {super();}

	public static void main(String[] args) { new InsiderAttackClassification().visualize("", false); }
