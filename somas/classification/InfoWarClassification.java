...
public class InfoWarClassification extends Scenario {

    public static final int numObjectives = 5; // TODO : change back to 6, set to 5 right now for backwards compatibility
    public static final String[] metricNames = {"activity metric", "good info", "bad info", "self organization", 
    	"feasibility",  "dead nodes"};
    
    public InfoWarClassification() {super();}

    public static void main(String[] args) { new InfoWarClassification().visualize("", false); }
    ...
    private void setupSimulation() {
		...
		*/
		...
		componentNetwork.addCompromiseAgents(false);
