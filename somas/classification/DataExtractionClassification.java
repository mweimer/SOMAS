...
public class DataExtractionClassification extends Scenario {
	...
	public DataExtractionClassification() {super();}
	
	public static void main(String[] args) { new DataExtractionClassification().visualize("", false); }
