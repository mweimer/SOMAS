...
public class CompetitionClassification extends Scenario {
	...
	public CompetitionClassification() {super();}

    public static void main(String[] args) { new CompetitionClassification().visualize("", false); }
	...
	public void run() {
		...
		try {
		    ...
		    simulation.setProperty("argList", new String[] {"-for", Scenario.numclasssteps.toString()}); // Do simulation for 100 steps
