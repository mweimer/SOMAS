...
public class InfoWarScenario extends Scenario {
    ...
    public InfoWarScenario() {super();}

    public static void main(String[] args) { new InfoWarScenario().visualize(args[0], true); }
