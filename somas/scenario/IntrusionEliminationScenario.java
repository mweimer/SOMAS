...
public class IntrusionEliminationScenario extends Scenario {
	...
	public IntrusionEliminationScenario() {super();}

	public static void main(String[] args) { new IntrusionEliminationScenario().visualize(args[0], true); }
